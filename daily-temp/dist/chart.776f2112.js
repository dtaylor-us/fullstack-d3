...
async function drawLineChart() {
  ...
  const bounds = wrapper.append("g") // create a group inside the svg. Like a div element in an SVG
  .style("transform", "translate(".concat(dimensions.margin.left, "px, ").concat(dimensions.margin.top, "px)"));
